...
int main()
{
    ...
    while (exit != 1)
    {
        ...
        int x;
        printf("\n\n=====================================================================================================================================\n\n");
        printf("\nHello, Player! Welcome to Merge2Win.\n\n");

        sleep(2);

        printf("Merge2win is a game that trains our brain to calculate in terms of powers of 2. Because 2 is the base of\n");
        printf("the binary number system, it is common to use the powers of 2 in computer science. This game requires \n");
        printf("us to quickly and mentally manipulate numbers thatare powers of 2, at the same time, strategize to \n");
        printf("win the game with the most stars.\n\n");
        ...
        while (gameover == 0)
        {
            ...
            if (difficulty == 1 && tokensConsumed != 0 && tokensConsumed % 51 == 0)
            {
                ...
                {
                    printf("\nYou have already consumed 50 tokens, what would you like to do:\n\n");
                    printf("[1] Restart\n");
                    printf("[2] Continue\n");
                    printf("[3] Quit\n");
                    printf(": ");
        ...
        if (gameover == 1) // means win
        {
            ...
            printf("Congratulations player! You WON with %d STARS!\n\n", stars);
            printf("===================================================================\n\n");
        }
