...
window = tk.Tk()
window.title("Road Construction Calculator - Bitumen Calculator (Prime Coat)")
...
label = tk.Label(window, text="Bitumen Calculator (Prime Coat)", font=font)
label.pack()
...
options = ["WMM/WBM", "Stabilized Soil Bases", "Crusher Run Macadam"]
...
def handle_selection(event):
    ...
    spray_rate = {
        "WMM/WBM" : 0.7, 
        "Stabilized Soil Bases" : 0.9, 
        "Crusher Run Macadam" : 0.9
    }
